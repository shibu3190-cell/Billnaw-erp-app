...
- **Not started**: `app.js` still contains POS/checkout — the only remaining piece. Order per `docs/ARCHITECTURE_TARGET.md` §8 complexity table: POS/checkout last (highest coupling, highest financial stakes).
